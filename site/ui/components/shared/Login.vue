  ...
  <div class="login container top">
    <form @submit.prevent="login">
      <div class="row">
        ...
        <div class="form-group col-sm-4 offset-sm-4" :class="{'has-danger': errors.has('username') && !invalidLogin}">
        ...
        <div class="form-group col-sm-4 offset-sm-4" :class="{'has-danger': errors.has('password') && !invalidLogin}">
